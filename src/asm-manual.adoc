...
|pmv.dbs rd, rs               | padd.dbs rd, x0, rs                                           | Move scalar into every element    | RV32 only
|pmv.dhs rd, rs               | padd.dhs rd, x0, rs                                           | Move scalar into every element    | RV32 only
|pmv.dws rd, rs               | padd.dws rd, x0, rs                                           | Move scalar into every element    | RV32 only
...
|negd rd, rs                  | psubd rd, x0, rs                                              | Two's complement dword            | RV32 only
|pabs.b rd, rs                | pabd.b rd, rs, x0                                             | Packed absolute value             |
|pabs.h rd, rs                | pabd.h rd, rs, x0                                             | Packed absolute value             |
|pabs.db rd, rs               | pabd.db rd, rs, x0                                            | Packed absolute value             | RV32 only
|pabs.dh rd, rs               | pabd.dh rd, rs, x0                                            | Packed absolute value             | RV32 only
...
|pzext.dh.b rd, rs            | ppaire.db rd, rs, x0                                          | Packed zero extend                | RV32 only
|pzext.dw.h rd, rs            | ppaire.dh rd, rs, x0                                          | Packed zero extend                | RV32 only
|pwcvt.b rd, rs               | pwadd.b rd, rs, x0                                            | Packed widening convert, signed   | RV32 only
|pwcvt.h rd, rs               | pwadd.h rd, rs, x0                                            | Packed widening convert, signed   | RV32 only
|pwcvtu.b rd, rs              | wzip8p rd, rs, x0                                             | Packed widening convert, unsigned | RV32 only
|pwcvtu.b rd, rs              | zip8p rd, rs, x0                                              | Packed widening convert, unsigned | RV64 only
|pwcvtu.h rd, rs              | wzip16p rd, rs, x0                                            | Packed widening convert, unsigned | RV32 only
...
|pncvt.b rd, rs               | pnsrli.b rd, rs, 0                                            | Packed narrowing convert          | RV32 only
|pncvt.b rd, rs               | unzip8p rd, rs, x0                                            | Packed narrowing convert          | RV64 only
|pncvt.h rd, rs               | pnsrli.h rd, rs, 0                                            | Packed narrowing convert          | RV32 only
|pncvt.h rd, rs               | unzip16p rd, rs, x0                                           | Packed narrowing convert          | RV64 only
|pncvth.b rd, rs              | pnsrli.b rd, rs, 8                                            | Packed narrowing convert high     | RV32 only
|pncvth.b rd, rs              | unzip8hp rd, rs, x0                                           | Packed narrowing convert high     | RV64 only
|pncvth.h rd, rs              | pnsrli.h rd, rs, 16                                           | Packed narrowing convert high     | RV32 only
...
|pmseqz.db rd, rs             | pmseq.db rd, rs, x0                                           | Packed mask-set if = zero      | RV32 only
|pmseqz.dh rd, rs             | pmseq.dh rd, rs, x0                                           | Packed mask-set if = zero      | RV32 only
|pmseqz.dw rd, rs             | pmseq.dw rd, rs, x0                                           | Packed mask-set if = zero      | RV32 only
...
|pmsnez.db rd, rs             | pmsltu.db rd, x0, rs                                          | Packed mask-set if != zero     | RV32 only
|pmsnez.dh rd, rs             | pmsltu.dh rd, x0, rs                                          | Packed mask-set if != zero     | RV32 only
|pmsnez.dw rd, rs             | pmsltu.dw rd, x0, rs                                          | Packed mask-set if != zero     | RV32 only
...
|pmsltz.db rd, rs             | pmslt.db rd, rs, x0                                           | Packed mask-set if < zero      | RV32 only
|pmsltz.dh rd, rs             | pmslt.dh rd, rs, x0                                           | Packed mask-set if < zero      | RV32 only
|pmsltz.dw rd, rs             | pmslt.dw rd, rs, x0                                           | Packed mask-set if < zero      | RV32 only
...
|pmsgtz.db rd, rs             | pmslt.db rd, x0, rs                                           | Packed mask-set if > zero      | RV32 only
|pmsgtz.dh rd, rs             | pmslt.dh rd, x0, rs                                           | Packed mask-set if > zero      | RV32 only
|pmsgtz.dw rd, rs             | pmslt.dw rd, x0, rs                                           | Packed mask-set if > zero      | RV32 only
...
|pmsgt.db rd, rs, rt          | pmslt.db rd, rt, rs                                           | Packed mask-set if >           | RV32 only
|pmsgt.dh rd, rs, rt          | pmslt.dh rd, rt, rs                                           | Packed mask-set if >           | RV32 only
|pmsgt.dw rd, rs, rt          | pmslt.dw rd, rt, rs                                           | Packed mask-set if >           | RV32 only
...
|pmsgtu.db rd, rs, rt         | pmsltu.db rd, rt, rs                                          | Packed mask-set if >, unsigned | RV32 only
|pmsgtu.dh rd, rs, rt         | pmsltu.dh rd, rt, rs                                          | Packed mask-set if >, unsigned | RV32 only
|pmsgtu.dw rd, rs, rt         | pmsltu.dw rd, rt, rs                                          | Packed mask-set if >, unsigned | RV32 only
