...
|pwcvtu.b rd, rs              | zip8p rd, rs, x0                                              | Packed widening convert, unsigned | RV64 only
|pwcvtu.h rd_p, rs            | wzip16p rd_p, rs, x0                                          | Packed widening convert, unsigned | RV32 only
|pwcvtu.h rd, rs              | zip16p rd, rs, x0                                             | Packed widening convert, unsigned | RV64 only
|pwcvth.b rd_p, rs            | wzip8p rd_p, x0, rs                                           | Packed widening convert high      | RV32 only
|pwcvth.b rd, rs              | zip8p rd, x0, rs                                              | Packed widening convert high      | RV64 only
|pwcvth.h rd_p, rs            | wzip16p rd_p, x0, rs                                          | Packed widening convert high      | RV32 only
|pwcvth.h rd, rs              | zip16p rd, x0, rs                                             | Packed widening convert high      | RV64 only
|pncvt.b rd, rs_p             | pnsrli.b rd, rs_p, 0                                          | Packed narrowing convert          | RV32 only
|pncvt.b rd, rs               | unzip8p rd, rs, x0                                            | Packed narrowing convert          | RV64 only
|pncvt.h rd, rs_p             | pnsrli.h rd, rs_p, 0                                          | Packed narrowing convert          | RV32 only
|pncvt.h rd, rs               | unzip16p rd, rs, x0                                           | Packed narrowing convert          | RV64 only
|pncvth.b rd, rs_p            | pnsrli.b rd, rs_p, 8                                          | Packed narrowing convert high     | RV32 only
|pncvth.b rd, rs              | unzip8hp rd, rs, x0                                           | Packed narrowing convert high     | RV64 only
|pncvth.h rd, rs_p            | pnsrli.h rd, rs_p, 16                                         | Packed narrowing convert high     | RV32 only
|pncvth.h rd, rs              | unzip16hp rd, rs, x0                                          | Packed narrowing convert high     | RV64 only
